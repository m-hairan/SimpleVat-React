...
public class ProjectEntity {
    ...
    private Collection<TransactonEntity> transactonsByProjectId;
    ...
    public Collection<TransactonEntity> getTransactonsByProjectId() {
        return transactonsByProjectId;
    }

    public void setTransactonsByProjectId(Collection<TransactonEntity> transactonsByProjectId) {

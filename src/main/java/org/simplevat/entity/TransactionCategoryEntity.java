...
public class TransactionCategoryEntity {
    ...
    private Collection<TransactonEntity> transactonsByTransactionCategoryCode;
    ...
    public Collection<TransactonEntity> getTransactonsByTransactionCategoryCode() {
        return transactonsByTransactionCategoryCode;
    }

    public void setTransactonsByTransactionCategoryCode(Collection<TransactonEntity> transactonsByTransactionCategoryCode) {

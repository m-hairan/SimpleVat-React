...
//            transactionModel.setAttachmentFileContent(new DefaultStreamedContent(inputStream));
    ...
    private Collection<Transaction> getChildTransactionList(Collection<TransactionRestModel> childTransactionModelList) {
    ...
    private List<TransactionViewRestModel> getChildTransactionViewModelList(Collection<TransactionViewRestModel> childTransactionList, Integer parentTransactionViewModelId) {
        List<TransactionViewRestModel> transactionModelList = new ArrayList<>();
        if (childTransactionList != null && !childTransactionList.isEmpty()) {
            childTransactionList.stream().filter((transactionViewModel) -> (transactionViewModel.getParentTransaction().equals(parentTransactionViewModelId))).forEachOrdered((transactionViewModel) -> {

...
public class TransactionTypeEntity {
    ...
    private Collection<TransactionEntity> transactonsByTransactionTypeCode;
    ...
    @OneToMany(mappedBy = "transactionTypeByTransactionTypeCode")
    public Collection<TransactionEntity> getTransactonsByTransactionTypeCode() {
        return transactonsByTransactionTypeCode;
    }

    public void setTransactonsByTransactionTypeCode(Collection<TransactionEntity> transactonsByTransactionTypeCode) {

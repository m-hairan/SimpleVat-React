...
public class BankAccountEntity {
    ...
    private Collection<TransactionEntity> transactonsByBankAccountId;
    ...
    @OneToMany(mappedBy = "bankAccountByBankAccountId")
    public Collection<TransactionEntity> getTransactonsByBankAccountId() {
        return transactonsByBankAccountId;
    }

    public void setTransactonsByBankAccountId(Collection<TransactionEntity> transactonsByBankAccountId) {

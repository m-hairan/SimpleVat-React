...
RUN set -x \
  ...
  && wget http://central.maven.org/maven2/mysql/mysql-connector-java/6.0.5/mysql-connector-java-6.0.5.jar  -P ${CATALINA_HOME}/lib  \  
  && wget http://central.maven.org/maven2/com/google/guava/guava/23.0/guava-23.0.jar  -P ${CATALINA_HOME}/lib  \  
  && wget http://central.maven.org/maven2/com/google/cloud/sql/mysql-socket-factory/1.0.0-beta1/mysql-socket-factory-1.0.0-beta1.jar  -P ${CATALINA_HOME}/lib  \  

                  ...
                  <Row>
                    <Col lg={12}>
                      <div className="h4 mb-0 d-flex align-items-center">
                        ...
                        <span className="ml-2">Update Purchase</span>
                      </div>
                    </Col>
                  </Row>
                </CardHeader>
                    ...
                    <Col lg={12}>
                      <Form>
                        ...
                        <Row>
                          ...
                          <Col lg={4}>
                            <FormGroup className="mb-3">
                              <Label htmlFor="purchase_due">Purchase Due</Label>
                              <Input
                                type="text"
                                id="purchase_due"
                                name="purchase_due"
                                placeholder="Enter Purchase Due"
                                required
                              />
                            </FormGroup>
                          </Col>
                    ...
                    <Col lg={12}>
                      <FormGroup className="text-right">
                        ...
                        <Button color="secondary" className="btn-square" 
                          onClick={() => {this.props.history.push('/admin/expense/purchase')}}>

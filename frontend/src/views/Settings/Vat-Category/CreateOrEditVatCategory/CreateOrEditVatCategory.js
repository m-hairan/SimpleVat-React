...
import { Card, CardHeader, CardBody, Button, Col, Row, FormGroup, Label, Input, Form } from 'reactstrap';
                            ...
                            <FormGroup>
                                <Col xs="4">
                                    <FormGroup>
                                        ...
                                        <Input type="text" id="name" name="name" value={name} placeholder="Enter Vat Category Name" onChange={this.handleChange} required />
                                    </FormGroup>
                                </Col>
                            </FormGroup>
                            <FormGroup>
                                <Col xs="4">
                                    <FormGroup>
                                        ...
                                        <Input type="number" id="name" name="vat" value={vat} placeholder="Enter Percentage" onChange={this.handleChange} required />
                                    </FormGroup>
                                </Col>
                            </FormGroup>
                            <FormGroup>

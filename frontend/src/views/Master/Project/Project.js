    ...
    render() {
        ...
        return (
            <div className="animated">
                ...
                <Card>
                    <CardHeader>
                        <i className="icon-menu"></i>Projects
                    </CardHeader>
                    <CardBody>
                        <Button className="mb-3" onClick={() => this.props.history.push(`/create-Project`)}>New</Button>
                        <BootstrapTable data={vatCategoryList} version="4" striped hover pagination={paginationFactory(this.options)} totalSize={vatCategoryList ? vatCategoryList.length : 0} >
                            ...
                            <TableHeaderColumn>Expense Budget</TableHeaderColumn>
                            <TableHeaderColumn>Revenue Budget</TableHeaderColumn>
                            <TableHeaderColumn >Vat Number</TableHeaderColumn>
                            <TableHeaderColumn >Currency Code</TableHeaderColumn>
